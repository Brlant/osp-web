        ...
        <div class="d-table-col-wrap" :style="'height:'+bodyHeight" @scroll="scrollLoadingData">
          <h2 class="header">
            <span class="pull-right">
              <perm label="openapi-department-add">
            ...
            <ul class="show-list">
              ...
              <li v-for="item in showTypeList" class="list-item" @click="showType(item,1)"
                ...
                <span class="hover-show">
                    <perm label="openapi-department-edit">
                      <a href="#" @click.stop.prevent="editDepartment(item)"
                         class="pull-right">
                        <i class="el-icon-t-edit"></i>
                      </a>
                    </perm>
                    <perm label="openapi-department-delete">
      ...
      <div class="d-table-right">
        <div class="d-table-col-wrap">
          <div>
           ...
           <perm label="openapi-access-platfrom-role-export">
          ...
          <span class="pull-right">
                ...
                <a href="#" class="btn-circle" @click.stop.prevent="showSearch=(!showSearch)" v-show="!showSearch">
                  <i class="el-icon-t-search"></i>
                    ...
                    <perm label="openapi-platform-user-add">
          ...
          <div v-else>
            <table class="table table-hover">
              ...
              <tr v-for="row in dataRows">
                ...
                <td class="list-op">
                  <perm label="openapi-platform-user-edit">
    ...
    methods: {
      deleteDepartment: function (item) {
        this.$confirm(`删除部门"${item.name}"会一并清空部门下的成员，确认删除？`, '', {
          ...
          this.$http.delete('/dhs/department/' + item.id, {}).then(() => {
            this.$notify.success({
              duration: 2000,
              title: '成功',
      ...
      exportUserRoles () {
        ...
        let params = {
          objectId: 'openapi-system', type: 0
        };
